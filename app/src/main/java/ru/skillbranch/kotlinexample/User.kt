...
class User private constructor (
    ...
    fun changePassword(oldPassword: String, newPassword: String) {
        ...
        else throw IllegalArgumentException("Entered password does not match the current password")
    }
    ...
    private fun generateAccessCode(): String {
        ...
        return StringBuilder().apply{
            repeat(6) {
                (possible.indices).random().also { rand_index ->
                    append(possible[rand_index])
                }
            }
        }.toString()
    }
    ...
    companion object Factory {
        fun makeUser(
            ...
            return when{
                ...
                else -> throw IllegalArgumentException("Email or phone should be not null or blank")
            }
        }
